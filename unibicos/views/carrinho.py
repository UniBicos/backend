...
def get_carrinho(request):
    ...
    pedido = Pedidos.objects.filter(id_cliente=comprador, status_pedido="RASCUNHO").first()
...
def remover_do_carrinho(request, produto_id):
    ...
    PedidoProdutos.objects.filter(id_pedido=pedido, id_produto_id=produto_id).delete()
...
def finalizar_carrinho(request):
    ...
    Pagamento.objects.create(id_pedido=pedido, status_pagamento="AGUARDANDO_PAGAMENTO")
