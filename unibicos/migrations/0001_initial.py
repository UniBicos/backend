        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name='emails_instituicao',
                        to='unibicos.instituicoesensino',
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'id_cliente',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='unibicos.compradores'
                    ),
                ),
                (
                    'id_entregador',
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, to='unibicos.pedidos'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'id_categoria',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='unibicos.categorias'
                    ),
                ),
                (
                    'id_loja',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'tipo_perfil',
                    models.CharField(
                        choices=[('ENTREGADOR', 'ENTREGADOR'), ('LOJA', 'LOJA')],
                        default='LOJA',
                        max_length=20,
                    ),
                ),
                ...
                (
                    'id_usuario',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='unibicos.usuario'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'id_produto',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to='unibicos.produtos'
                    ),
                ),
            ],
            options={
